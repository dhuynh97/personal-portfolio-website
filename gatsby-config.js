...
module.exports = {
  siteMetadata: {
    title: 'Daniel Huynh – AI/ML & Cloud Consultant',
    description:
      'Solutions engineer specializing in AI/ML development, Google Cloud architecture, and enterprise consulting on the Google Marketing Platform.',
